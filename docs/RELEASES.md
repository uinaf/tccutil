...
3. `semantic-release` prepares the Cargo files, commits them through GitHub's signed App commit API, then creates the version tag and a mutable draft GitHub Release
